...
firewall-cmd --add-port={10250,30000-32767,5473,179,5473,6783}/tcp --permanent --zone=public
firewall-cmd --add-port={4789,8285,8472,6783,6784}/udp --permanent --zone=public
firewall-cmd --reload
